...
Overview :
This repository contains the implementation, execution, and analysis of Hadoop MapReduce and Apache Spark tasks as part of the CSL7110 assignment.
...
All programs were executed on a local single-node Hadoop and Spark setup using WSL. Screenshots of executions are included in the submitted PDF as per requirement
________________________________________
